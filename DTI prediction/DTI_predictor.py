...
# Balanced with One-SVM-US ############################################################################
df_final = pd.read_csv('DTI prediction/df_final_NR_AB.csv')
...
# Balanced with random undersampling ##################################################################
df_rand = pd.read_csv('DTI prediction/df_NR_AB_rand.csv')
...
#######################################################################################################
# Read selected feature list
df_features_rand = pd.read_csv('DTI prediction/subset_accuracy_NR_AB_rand.csv')
...
## Create a XGBoost Classifier##########################################################################
classifier_xgb = XGBClassifier(eval_metric='logloss', objective='binary:logistic')
